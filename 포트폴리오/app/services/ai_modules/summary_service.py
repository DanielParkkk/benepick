...
from .benefit_extractor import extract_benefit_estimate
...
class PolicySummaryService:
    ...
    def summarize_policy(self, policy_text: str) -> Dict[str, object]:
        ...
        benefit_estimate = extract_benefit_estimate(cleaned_policy_text or raw_policy_text)
        ...
        return {
            ...
            "unit_amount": benefit_estimate.get("unit_amount"),
            "period_months": benefit_estimate.get("period_months"),
            "annual_amount": benefit_estimate.get("annual_amount"),
            "annual_amount_label": benefit_estimate.get("annual_amount_label"),
            "calculation_type": benefit_estimate.get("calculation_type"),
            "calculation_basis": benefit_estimate.get("calculation_basis"),
            "benefit_confidence": benefit_estimate.get("confidence"),
            "benefit_evidence_text": benefit_estimate.get("evidence_text"),
            "is_cash_equivalent": benefit_estimate.get("is_cash_equivalent"),
        }

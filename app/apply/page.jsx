      ...
      <div className="container">
        <div className="screen active" id="screen-apply">
          ...
          <div className="flow-steps">
            <div className="flow-step done"><div className="num">✓</div><span className="label" data-i18n="flow_info">정보 입력</span></div>
            <div className="flow-arrow">→</div>
            <div className="flow-step done"><div className="num">✓</div><span className="label" data-i18n="flow_ai">AI 분석</span></div>
            <div className="flow-arrow">→</div>
            <div className="flow-step done"><div className="num">✓</div><span className="label" data-i18n="flow_cause">원인 파악</span></div>
            <div className="flow-arrow">→</div>
            <div className="flow-step active"><div className="num">4</div><span className="label" data-i18n="flow_docs">서류 준비</span></div>
            <div className="flow-arrow">→</div>
            <div className="flow-step"><div className="num">5</div><span className="label" data-i18n="flow_done">신청 완료</span></div>
          </div>

      ...
      try {
        ...
        if (res.ok) {
          ...
          const backendPolicy = {
            ...
            선정기준: raw.selection_criteria_text || '',
            제한대상: raw.restricted_target_text || '',
            신청방법: raw.application_method_text || '',
            신청기한: raw.application_period_text || '',
            필요서류: raw.required_documents_text || '',
            심사방법: raw.screening_method_text || '',
            전화문의: raw.contact_text || '',

  ...
  return (
    <>
      <style>{`
        ...
        .auth-logo-name {
          font-family: 'Plus Jakarta Sans', sans-serif;
          font-size: 36px; font-weight: 800; color: #4A90E2; letter-spacing: -1.5px;
        }
        .auth-card {
        ...
        .auth-input-group {
          border: 1.5px solid #dadada; border-radius: 4px;
        ...
        .auth-input {
          ...
          outline: none; background: #fff; transition: background 0.15s;
        ...
        .global-error {
          display: none; font-size: 12px; color: #e74c3c;
        ...
        .remember-check {
          ...
          cursor: pointer; font-size: 13px; color: #555; user-select: none;
        }
        .check-circle {
          width: 19px; height: 19px; border: 1.5px solid #ccc;
        ...
        .toggle-track {
          position: absolute; inset: 0; background: #bbb; border-radius: 12px;
          transition: background 0.2s; display: flex; align-items: center;
          padding: 3px; justify-content: flex-start;
        }
        .toggle-knob {
        ...
        .btn-login {
          width: 100%; padding: 15px; background: #bbb; color: #fff;
          border: none; border-radius: 4px; font-size: 17px; font-weight: 700;
          font-family: 'Pretendard', sans-serif; cursor: pointer;
          transition: background 0.18s; margin-bottom: 20px;
          display: flex; align-items: center; justify-content: center; gap: 8px;
        }
        .btn-login.ready { background: #4A90E2; cursor: pointer; }
        .btn-login.ready:hover { background: #2B6CB0; }
        .sns-row { display: flex; gap: 8px; }
        .btn-sns {
          flex: 1; padding: 11px 8px; border: 1.5px solid #e0e0e0;
          border-radius: 4px; background: #fff; font-size: 13px; font-weight: 600;
          font-family: 'Pretendard', sans-serif; color: #555; cursor: pointer;
      ...
      <div className="auth-page">
        ...
        <div className="auth-card">
          ...
          <button
            className={`btn-login${isReady ? ' ready' : ''}`}
            onClick={handleLogin}
            disabled={loading}
          >
            {loading ? '로그인 중...' : '로그인'}
          ...
          <div className="sns-row">
            ...
            <button className="btn-sns naver" onClick={handleNaverLogin} disabled={loading}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <path d="M13.8 12.3L9.9 6H6v12h4.2V11.7l3.9 6.3H18V6h-4.2v6.3z" fill="#fff"/>
              </svg>
              네이버 로그인
            </button>

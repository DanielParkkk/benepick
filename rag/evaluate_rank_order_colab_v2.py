...
def main() -> None:
    ...
    for mode in args.modes:
        ...
        summary = {
            ...
            "mode": mode,
            "embedding_model": os.getenv("BENEPICK_EMBED_MODEL", "BAAI/bge-m3"),
            "welfare_embeddings_path": os.getenv("BENEPICK_WELFARE_EMBEDDINGS_PATH", ""),
            "gov24_embeddings_path": os.getenv("BENEPICK_GOV24_EMBEDDINGS_PATH", ""),
            "top_k": args.top_k,
